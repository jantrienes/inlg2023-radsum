...
3. [Data](#data)
   1. [MIMIC](#mimic)
   2. [OpenI](#openi)
   3. [Outputs, Manual Annotations, Checkpoints](#outputs-manual-annotations-checkpoints)
...
Use following scripts to download and pre-process the raw data.
...
### Outputs, Manual Annotations, Checkpoints
...
| Model outputs | Outputs generated by all summarization models. | MIMIC-CXR (tba) \| OpenI (tba) | `outputs/` |
| Checkpoints | Pre-trained models. | MIMIC-CXR (tba) \| OpenI (tba) | `outputs/` |
