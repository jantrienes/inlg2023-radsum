...
###### General ######
export DATASET_NAME=openi-bg
export DATA_BUILDER_EXTRA_ARGS=--include_background
export GENERATION_BEST_METRIC=rouge_1_f_score
...
# WGsum
export WGSUM_TRAIN_STEPS=20000
export WGSUM_CHECKPOINT_STEPS=200

# WGSum+CL
export WGSUM_CL_TRAIN_STEPS=20000
export WGSUM_CL_CHECKPOINT_STEPS=200

###### Path Configuration ######
export DATA_PROCESSED=data/processed/openi  # We start from the default dataset, no -bg suffix needed here.
